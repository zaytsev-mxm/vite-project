...
import {
  ...
  renderTextWithEntities2,
} from './178-twitter-mention-hashtag.ts';

const TEXT =
  'Shaku syntax is now supported on https://t.co/UpkmJ7yGKG! Give it a try to annotate your code ! kudos to @JSer_ZANP for making such a great tool !';
...
describe('renderTextWithEntities', () => {
  it('should render a correct string', () => {
    const expected =
      'Shaku syntax is now supported on <a href="https://t.co/UpkmJ7yGKG">BFE.dev</a>! Give it a try to annotate your code ! kudos to <a href="https://x.com/JSer_ZANP">@JSer_ZANP</a> for making such a great tool !';

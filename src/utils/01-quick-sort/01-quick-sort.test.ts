...
describe("quickSort", () => {
  ...
  describe("multiple elements", () => {
    ...
    it("should sort array with three elements", () => {
  ...
  describe("large arrays", () => {
    ...
    it("should handle large array with random values", () => {
      const input = [87, 23, 45, 12, 99, 34, 56, 78, 90, 11, 67, 43, 21, 88, 55];
  ...
  describe("special values", () => {
    ...
    it("should handle array with both Infinities", () => {
      expect(quickSort([0, Infinity, -Infinity])).toEqual([-Infinity, 0, Infinity]);
    });
  });
